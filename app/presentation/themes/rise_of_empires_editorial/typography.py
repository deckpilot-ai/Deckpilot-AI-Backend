"""Typography Engine and Measurement Services for Rise of Empires Editorial Theme.
...
from app.presentation.themes.rise_of_empires_editorial.tokens import FONTS
...
BUDGETS = {
    "cover_title": TypographyBudget(preferred_pt=56.0, min_pt=42.0, max_pt=60.0, max_lines=2, max_chars=55),
    "slide_title": TypographyBudget(preferred_pt=27.0, min_pt=23.0, max_pt=30.0, max_lines=2, max_chars=70),
    "card_title": TypographyBudget(preferred_pt=15.0, min_pt=13.0, max_pt=18.0, max_lines=2, max_chars=45),
    "body": TypographyBudget(preferred_pt=14.5, min_pt=11.5, max_pt=16.0, max_lines=6, max_chars=260),
    "compact_body": TypographyBudget(preferred_pt=12.0, min_pt=10.5, max_pt=13.5, max_lines=8, max_chars=320),
...
class TextMeasurementService:
    ...
    def estimate(
        ...
        # Cambria is wider and has tall serifs (~0.54), Calibri is narrower (~0.49)
